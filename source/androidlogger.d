...
class AndroidLogger : FileLogger {
  ...
  override void writeLogMsg(ref LogEntry payload) {
    with (payload) {
      ...
      this.file.lockingTextWriter().put(colorize("%02d-%02d %02d:%02d:%02d.%03d %d %s %s %s: %s\n".format(
  ...
  private auto colorize(string s, LogLevel logLevel) {
    ...
    switch (logLevel) {
    case LogLevel.trace: return s.black.onDefaultColor;
    case LogLevel.info: return s.defaultColor.onDefaultColor;
    case LogLevel.warning: return s.green.onDefaultColor;
    case LogLevel.error: return s.yellow.onDefaultColor;
    case LogLevel.critical: return s.black.onRed;
    case LogLevel.fatal: return s.yellow.onRed;
    default: assert(0);
    }
  }
}
